...
- `fun/robot_dance.py` is a safe demo: it streams compliant eased offsets around the *current* EE pose with hard speed/box/force clamps and an offline `--selftest`.
